...
import com.csv.transform.transformationStrategies.lowLevel.map.MapByHighLevelKeywordColumn;
...
@Component
public class HighLevelKeywordTransformation implements TransformationStrategy<CsvTable, Pair<CsvTable, ExcelIndexTable>> {
    @Autowired
    NormalizeColumns normalizeColumns;
    @Autowired
    RemoveEmptyColumns removeEmptyColumns;
    @Autowired
    MapByHighLevelKeywordColumn mapByHighLevelKeywordColumn;
    @Autowired
    ...
    public Pair<CsvTable, ExcelIndexTable> transform(CsvTable input) {
        ...
        var tables = mapByHighLevelKeywordColumn.transform(removed);
